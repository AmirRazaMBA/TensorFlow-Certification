...
sentences = []
labels = []
with open("D:\\Sandbox\\Github\\DATA\\bbc-text.csv", 'r') as csvfile:
    # Your Code here
...
label_word_index = word_index[854]

label_tokenizer = Tokenizer(num_words=100, oov_token=oov_tok)
label_seq = label_tokenizer.fit_on_texts(labels)
